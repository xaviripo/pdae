...
//            //play_note(n);
//            uint8_t counter = 0;
//            do { // Tira hacia atr�s "ajustando" la direcci�n para no chocar contra los muros
...
//
//                rotate_left(BACKWARD, wall == RIGHT ? speed_wall : speed_wallnt); // TODO comprobar si es wallnt : wall o al revés
...
//            reset_sec_time();
//            //play_note(n);
//            do { // Giramos en sentido can�nico hasta estar "paralelo" al deadend
//                if (has_passed_sec(1000)) {
//                    reset_sec_time();
//                    stop_sound();
//                    //play_note(n);
...
//           // play_note(n);
//            counter = 0;
//            do { // Seguimos girando para compensar que a�n no est� paralelo
//                if (has_passed_sec(1000)) {
//                    reset_sec_time();
//                    stop_sound();
//                    //play_note(n);
