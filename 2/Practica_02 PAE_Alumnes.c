   	...
   	if (estado_anterior != estado)			// Dependiendo del valor del estado se encenderá un LED u otro.
	{
        ...
        ***********************************************************/
        ...
        case 5:
            ...
            retraso_leds = retraso_leds + INC_RETRASO < retraso_leds ? INT32_MAX : retraso_leds + INC_RETRASO;
            break;
        case 6:
            P2OUT &= ~BIT6;
            P2OUT |= BIT4;
            ...
            retraso_leds = retraso_leds - INC_RETRASO > retraso_leds ? 1 : retraso_leds - INC_RETRASO;
            break;
        case 7:
            P2OUT ^= BIT4 | BIT6;
            P5OUT ^= BIT6;
